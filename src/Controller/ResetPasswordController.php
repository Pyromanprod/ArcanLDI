...
class ResetPasswordController extends AbstractController
{
    ...
    #[IsGranted('ROLE_USER')]
    public function requestReset(MailerInterface $mailer,UserRepository $userRepository): Response
    {
            return $this->processSendingPasswordResetEmail(
     ...
     */
    #[Route('/verificaiton-mail', name: 'app_check_email')]
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager, string $token = null): Response
    {
        ...
        if (null === $token) {
            throw $this->createNotFoundException('Le token est introuvable.');
        }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, UserRepository $repository): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('reset@arcanlesdemonsdivoire.fr', 'Arcan Reinitialisation Mot De Passe'))
            ->to($user->getEmail())
